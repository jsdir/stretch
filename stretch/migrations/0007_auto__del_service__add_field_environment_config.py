...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'stretch_service')

        # Adding field 'Environment.config'
        db.add_column(u'stretch_environment', 'config',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'stretch_service', (
            ('name', self.gf('django.db.models.fields.TextField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('system', self.gf('django.db.models.fields.related.ForeignKey')(related_name='services', to=orm['stretch.System'])),
        ...
        db.send_create_signal(u'stretch', ['Service'])

        # Deleting field 'Environment.config'
        db.delete_column(u'stretch_environment', 'config')
    ...
    models = {
        ...
        u'stretch.node': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {}),
            'ports': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
