...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Host.domain_name'
        db.alter_column(u'stretch_host', 'domain_name', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Host.domain_name'
        raise RuntimeError("Cannot reverse this migration. 'Host.domain_name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Host.domain_name'
        db.alter_column(u'stretch_host', 'domain_name', self.gf('django.db.models.fields.TextField')())
