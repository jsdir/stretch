...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Environment.app_paths'
        db.add_column(u'stretch_environment', 'app_paths',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Environment.app_paths'
        db.delete_column(u'stretch_environment', 'app_paths')
